...
SECRET_KEY = 'django-insecure-d=te9b1q3o8)&f9#c#q(%k^=hw=)ho4i-q7o-5cy2+k-_q7q%^'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': os.environ.get("DB_NAME_USERINFO", "user_info"),  # user_info DB
    ...
    'friend_db': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': os.environ.get("DB_NAME_FRIEND", "friend"),  # friend DB
        'USER': os.environ.get("DB_USER"),
        'PASSWORD': os.environ.get("DB_PASSWORD"),
        'HOST': os.environ.get("DB_HOST"),
        'PORT': os.environ.get("DB_PORT"),
    ...
    'horse_data': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': os.environ.get("DB_NAME_HORSE", "horse_data"),  # horse_data DB
        'USER': os.environ.get("DB_USER"),
        'PASSWORD': os.environ.get("DB_PASSWORD"),
        'HOST': os.environ.get("DB_HOST"),
        'PORT': os.environ.get("DB_PORT"),
